...
export function LoadingSpinner({ size = "md", className }: LoadingSpinnerProps) {
  ...
  return (
    <svg
      ...
      role="img"
      viewBox="0 0 56 56"
      className={cn("loader", sizeClass[size], className)}
    >
      ...
      <g transform="translate(2,2)">
        ...
        <g transform="translate(13.75,9.25)" className="loader__model">
          <path
            ...
            fill="hsl(var(--primary-hue, 210),90%,85%)"
          ></path>
          ...
          <rect height="2" width="24.5" fill="hsl(var(--primary-hue, 210),90%,50%)"></rect>
          <rect
            height="1"
            width="19.5"
            y="0.5"
            ...
            ry="0.5"
            rx="0.5"
            fill="hsl(var(--primary-hue, 210),90%,57.5%)"
          ></rect>
          <rect
            height="2"
            width="24.5"
            y="31.5"
            fill="hsl(var(--primary-hue, 210),90%,50%)"
          ></rect>
          <rect
            height="1"
            width="19.5"
