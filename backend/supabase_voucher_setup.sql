...
-- =============================================
-- 8. FIX USERS TABLE COMPATIBILITY ISSUE
-- =============================================

-- Create a view called "users" that maps to the profiles table
-- This fixes the "relation users does not exist" error during signup
...
BEGIN
    RAISE NOTICE '==============================================';
    RAISE NOTICE 'MedQuest Database Setup Complete!';
    RAISE NOTICE '==============================================';
    RAISE NOTICE 'Tables created:';
    RAISE NOTICE '- vouchers';
    RAISE NOTICE '- voucher_usages';
    RAISE NOTICE '- users (view mapping to profiles)';
    ...
    RAISE NOTICE 'Compatibility fixes applied:';
    RAISE NOTICE '- Users table view with full CRUD operations';
    RAISE NOTICE '==============================================';
END $$;
